...
public:
  ...
  inline bool getTorqueActive() const;
...
public:
  ...
  inline bool getTorqueActive();
  inline void setTorqueActive(bool value);
...
inline bool CarStateSP::Reader::getTorqueActive() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<32>() * ::capnp::ELEMENTS);
}

inline bool CarStateSP::Builder::getTorqueActive() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<32>() * ::capnp::ELEMENTS);
}
inline void CarStateSP::Builder::setTorqueActive(bool value) {
  _builder.setDataField<bool>(
      ::capnp::bounded<32>() * ::capnp::ELEMENTS, value);
}
